...
const TRANSLATIONS = {
  pt: {
    ...
    'hero.btn.dev':         'EXPLORAR SISTEMAS E ARQUITETURA',
    'hero.btn.curious':     'EXPLORAR INTERFACES VISUAIS',
  ...
  en: {
    ...
    'hero.btn.dev':         'EXPLORE SYSTEMS & ARCHITECTURE',
    'hero.btn.curious':     'EXPLORE VISUAL INTERFACES',
